...
from pnw.utils import *
from pnw.bleu import evaluate
...
class CaptioningSolver(object):
    def __init__(self, model, data, val_data, **kwargs):
        ...
        self.test_model = kwargs.pop('test_model', './model/lstm1/model-1')
    ...
    def test(self, data = None, split='train', attention_visualization=True, save_sampled_captions=False):
        '''
        Args:
        ...
        #alphas, betas, \
        sampled_captions = self.model.build_sampler(max_len=20)    # (N, max_len, L), (N, max_len)
